...
At the end I created a powershell approach that is indeed able to list only dead drives cause they are lack of an actual path:
*Get-WmiObject Win32_LogicalDisk -Filter "DriveType = 4" | Where-Object { [string]::IsNullOrEmpty($_.ProviderName) }*
